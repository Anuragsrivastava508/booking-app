...
export default function DoctorDashboardPage() {
  ...
  if (!doctorData) {
    return (
      <div className="min-h-screen bg-slate-50 flex items-center justify-center">
        <div className="text-center bg-white shadow-md rounded-2xl px-8 py-6 border border-slate-100">
    ...
    <ProtectedRoute allowedRoles={["doctor"]}>
      <div className="min-h-screen bg-gradient-to-b from-sky-50 via-slate-50 to-slate-100">
        ...
        <main className="max-w-7xl mx-auto px-3 sm:px-4 lg:px-6 py-6 sm:py-8">
          {/* Welcome Section */}
          <div className="bg-white/80 backdrop-blur-sm rounded-3xl shadow-sm border border-slate-200/70 p-6 sm:p-8 mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <h1 className="text-2xl sm:text-3xl font-bold text-slate-900 mb-2">
                Welcome back,{" "}
                <span className="text-sky-600">Dr. {doctorData?.fullname}</span>
              </h1>
              <p className="text-slate-600">
                Here’s a quick overview of your practice today.
              </p>
            </div>
            <div className="hidden sm:flex items-center gap-3 bg-sky-50 border border-sky-100 rounded-2xl px-4 py-3">
              ...
              <div className="text-xs text-slate-600">
                <p className="font-semibold text-slate-800">
                  Active patients:{" "}
                  <span className="text-sky-600">{patients.length}</span>
                </p>
                <p>Keep track of appointments and refills in real-time.</p>
              </div>
            </div>
          </div>
          ...
          {unreadNotifications.length > 0 && (
            <div className="mb-8">
              <div className="bg-white rounded-3xl shadow-sm border border-sky-100 p-6 sm:p-7">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-5">
                  <div className="flex items-center gap-3">
                    <div className="p-2.5 bg-sky-100 rounded-xl">
                      <Bell className="h-6 w-6 text-sky-600 animate-pulse" />
                    </div>
                    <div>
                  ...
                  <button
                    ...
                    className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-sky-600 text-white text-sm font-medium rounded-xl shadow-sm hover:bg-sky-700 hover:shadow-md transition-all"
                  >
                    View all
                ...
                <div className="space-y-3">
                  {unreadNotifications.slice(0, 3).map((notification) => (
                    <div
                      ...
                      className={`border rounded-2xl px-4 py-3.5 transition-all cursor-pointer ${getNotificationColor(
                        notification.type
                      )}`}
                      onClick={() => router.push("/doctor/notifications")}
                    >
                      <div className="flex items-start gap-3">
                        <div
                          className={`p-2 rounded-xl flex-shrink-0 ${getNotificationIconColor(
                            notification.type
                          )}`}
                        >
                        ...
                        {notification.type === "ADR_ALERT" && (
                          <span className="px-2 py-1 bg-red-100 text-red-700 text-[10px] font-bold rounded-full animate-pulse">
                            URGENT
                          </span>
                        )}
                      </div>
                  ...
                  {unreadNotifications.length > 3 && (
                    <button
                      onClick={() => router.push("/doctor/notifications")}
                      className="w-full text-center text-sm text-sky-700 hover:text-sky-800 font-medium py-2 hover:bg-sky-50 rounded-xl transition-colors"
                    >
              ...
              <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-6 sm:p-7">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <span className="bg-sky-50 text-sky-700 text-xs font-semibold px-2.5 py-1 rounded-full border border-sky-100">
                ...
                <div className="space-y-3">
                  {refillRequests.slice(0, 5).map((request, index) => (
                    <div
                      key={index}
                      className="border border-slate-100 rounded-2xl p-4 hover:bg-slate-50/80 transition-colors"
                    >
                ...
                <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-6">
                  <div className="flex items-center justify-between mb-5">
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2 bg-sky-600 text-white text-sm font-medium rounded-xl hover:bg-sky-700 shadow-sm hover:shadow-md transition-all"
                    >
                  ...
                  <div className="space-y-3 max-h-96 overflow-y-auto pr-1">
                    {patients.slice(0, 5).map((patient) => (
                      <div
                        ...
                        className="flex items-center gap-4 p-3.5 bg-slate-50 rounded-2xl hover:bg-slate-100 hover:shadow-sm transition-all cursor-pointer border border-slate-100"
                        onClick={() =>
                      ...
                      >
                        <div className="flex-shrink-0">
                          {patient.patientDetails?.profilePic ? (
                            ...
                            <div className="h-11 w-11 rounded-full bg-sky-100 flex items-center justify-center border-2 border-sky-200">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <p className="text-xs text-slate-500">
                            {patient.patientDetails?.age
                              ? `${patient.patientDetails.age} yrs`
                              : "Age N/A"}{" "}
          ...
          {(!upcomingAppointments || upcomingAppointments.length === 0) &&
            (!completedAppointments || completedAppointments.length === 0) &&
            (!patients || patients.length === 0) && (
              <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-10 sm:p-12 text-center mb-8">
                <div className="max-w-md mx-auto">
                  ...
                  <p className="text-slate-600 mb-6 text-sm">
                    You don’t have any patients or appointments yet. Add a
                    patient to get started, or wait for bookings to appear here.
                  </p>
                  <button
                    onClick={() => router.push("/doctor/patient/add")}
                    className="inline-flex items-center gap-2 px-6 py-3 bg-sky-600 text-white rounded-xl hover:bg-sky-700 shadow-sm hover:shadow-md transition-all text-sm font-medium"
                  >
          ...
          {/* Quick Actions */}
          <div className="bg-white rounded-3xl shadow-sm border border-slate-200 p-6 sm:p-7 mt-4 mb-4">
            <div className="mb-5">
              <h2 className="text-lg font-semibold text-slate-900">
                Quick actions
              </h2>
              <p className="text-xs text-slate-500 mt-1">
                Frequently used actions for your daily workflow.
              </p>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              <button
                onClick={() => router.push("/doctor/patient/add")}
                className="flex items-center p-4 bg-sky-50 rounded-2xl hover:bg-sky-100 hover:shadow-sm transition-all border border-sky-100"
              >
                <div className="p-3 bg-sky-100 rounded-xl mr-3">
              ...
              <button
                ...
                className="flex items-center p-4 bg-emerald-50 rounded-2xl hover:bg-emerald-100 hover:shadow-sm transition-all border border-emerald-100"
              >
              ...
              <button
                ...
                className="flex items-center p-4 bg-violet-50 rounded-2xl hover:bg-violet-100 hover:shadow-sm transition-all border border-violet-100"
              >
              ...
              <button
                ...
                className="flex items-center p-4 bg-slate-50 rounded-2xl hover:bg-slate-100 hover:shadow-sm transition-all border border-slate-200"
              >
                <div className="p-3 bg-slate-100 rounded-xl mr-3">
